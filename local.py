...
class NIfTIDataset(Dataset):
    ...
    def _list_files_in_dir(self):
        ...
        self.training_files = [element for element in self.training_files if not element.startswith == "._"]
        self.label_files = [element for element in self.label_files if not element.startswith == "._"]
